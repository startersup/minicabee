...
<section class="about abbanner">
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-8">
     <input  class="controls" type="text" placeholder="Enter Booking Reference Id or Customer Id " name="pick" required="" autocomplete="off">
   </div>
    <div class="col-md-4">
       <button type="submit" class="buttonexplore">Track</button>
     </div>
   </div>
    </div>
